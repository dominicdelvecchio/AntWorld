 ...
 */
public class DefenceBrain extends AntBrain
{
  /**
   * Nest Position
   */
  ...
  public DefenceBrain(AntData ant, CommData commData, WorldMap map, LinkedList<Tiles> exploreDeque,
  ...
  public void stasis()
  {
    data.myAction = new AntAction(AntAction.AntActionType.STASIS);
  }
  ...
  {
    data.myAction = new AntAction(AntAction.AntActionType.ATTACK, dir);
  }
  ...
  {
    data.myAction = new AntAction(AntAction.AntActionType.PICKUP, dir, data.antType.getCarryCapacity());
  }
  ...
  {
    data.myAction = new AntAction(AntAction.AntActionType.PICKUP, dir, quantity);
  }
  ...
  public void heal()
  {
    data.myAction = new AntAction(AntAction.AntActionType.HEAL);
  }
  ...
  {
    data.myAction = new AntAction(AntAction.AntActionType.MOVE, Direction.getRandomDir());
  }
  ...
  {
    data.myAction = new AntAction(AntAction.AntActionType.ENTER_NEST);
  }
  ...
  {
    data.myAction = new AntAction(AntAction.AntActionType.EXIT_NEST, p.x, p.y);
  }
  ...
  {
    data.myAction = new AntAction(AntAction.AntActionType.EXIT_NEST, x, y);
  }
